...
<script type="text/javascript">
		...
		$(".jian").click(function(){
			...
			if(quantity==1){
				if(confirm("您是否真要删除该条目？")){
					location = "/ssm_01/cartItem/batchDelete.do?cartItemIds="+id;
				}
			}else{
	...
	function sendUpdateQuantity(id,quantity){
		$.ajax({
			async:false,
			cache:false,
			url:"/ssm_01/cartItem/updateQuantity.do",
	...
	*/
	...
	function batchDelete(){
		...
		location="/ssm_01/cartItem/batchDelete.do?cartItemIds="+cartItemIdArray.toString();
	}
	/*结算方法*/
	function jiesuan(){
		var cartItemIdArray = new Array();
