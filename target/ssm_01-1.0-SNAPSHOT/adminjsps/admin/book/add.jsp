...
function loadChildren(){
	...
	$.ajax({
		type:"POST",
		url:"/ssm_01/admin/book/ajaxFindChildren.do",
		data:{pid:pid},
		dataType:"JSON",
		async:true,
		cache:false,
  ...
  <div>
   ...
   <form action="/ssm_01/admin/book/addBook.do" enctype="multipart/form-data" method="post" id="form">
    <div>
	    <ul>
	    	...
	    	<li>当前价：<input id="price" type="text" name="currPrice" value="40.7" style="width:50px;"/></li>
	    	<li>定价：　<input id="currPrice" type="text" name="price" value="59.0" style="width:50px;"/>
            &nbsp;&nbsp; &nbsp;&nbsp;
