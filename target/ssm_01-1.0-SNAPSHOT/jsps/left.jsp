 ...
 * 第一个参数必须和变量名相同
 */
	var bar = new Q6MenuBar("bar", "叮咚书城");
	$(function() {
		...
		3. /ssm_01/jsps/book/list.jsp：点击二级分类后链接到的URL
		4. body:链接的内容在哪个框架页中显示
		*/
		<c:forEach items="${parents}" var="parent">
    		<c:forEach items="${parent.children}" var="child">
				bar.add("${parent.cname}", "${child.cname}", "/ssm_01/book/findByCategory.do?cid=${child.cid}", "body");
    		</c:forEach>
		</c:forEach>
...
<body>
    <div id="menu" style="height: auto;overflow:hidden "></div>
</body>
</html>
